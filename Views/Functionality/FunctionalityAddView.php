...
<head>
    ...
    <main role="main" class="margin-main ml-sm-auto px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mb-3 border-bottom">
            <h1 class="h2">Insertar funcionalidad</h1>
        ...
        <form action='../Controllers/FunctionalityController.php?action=add' method='POST'>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="IdFunctionality" name="IdFunctionality" placeholder="Introducir IdFunctionality">
            </div>
            <div class="form-group">
