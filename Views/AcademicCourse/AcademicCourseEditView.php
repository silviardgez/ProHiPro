            ...
            <form id="academicCourseForm" name = "EDIT" action='../Controllers/AcademicCourseController.php?action=edit' method='POST' onsubmit="return checkEditAcademicCourse()">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="2000" max="9999" class="form-control" id="start_year" name="start_year"
                           value="<?php echo $this->academicCourse->getStartYear() ?>" required onblur="checkEmpty(this)">
                </div>
                <div class="form-group">
                    ...
                    <input type="number" min="2000" max="9999" class="form-control" id="end_year" name="end_year"
                           value="<?php echo $this->academicCourse->getEndYear() ?>" required onblur="checkEmpty(this)">
                </div>
