...
class AcademicCourseEditView {
    ...
    function render(){
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            ...
            <form id="academicCourseEditForm" name = "EDIT" action='../Controllers/AcademicCourseController.php?action=edit'
                  method='POST' onsubmit="return areAcademicCourseEditFieldsCorrect()">
