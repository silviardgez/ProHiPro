...
class AcademicCourseSearchView {
    ...
    function render(){
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            ...
            <form id="academicCourseSearchForm" action='../Controllers/AcademicCourseController.php?action=search' method='POST'
                  onsubmit="return areAcademicCourseSearchFieldsCorrect()">
