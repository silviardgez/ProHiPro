...
<head>
    ...
    <main role="main" class="margin-main ml-sm-auto px-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mb-3 border-bottom">
            <h1 class="h2" data-translate="Insertar curso académico"></h1>
            <a class="btn btn-primary" role="button" href="../Controllers/AcademicCourseController.php"><p data-translate="Volver"></p></a>
        </div>
        <form  id="academicCourseForm" name = "ADD" action='../Controllers/AcademicCourseController.php?action=add' method='POST' onsubmit="return checkAddAcademicCourse()">
            <div class="form-group">
                ...
                <input type="number" min="2000" max="9999" class="form-control" id="start_year" name="start_year"
                       data-translate="Introducir año de inicio" onblur="checkEmpty(this)" required>
            </div>
            <div class="form-group">
                ...
                <input type="number"  min="2000" max="9999" class="form-control" id="end_year" name="end_year"
                       data-translate="Introducir año de fin" onblur="checkEmpty(this)" required>
            </div>
