...
class CenterEditView {
    ...
    function render(){
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            ...
            <form id="centerForm" action='../Controllers/CenterController.php?action=edit&id=<?php echo $this->center->getId() ?>'
                  method='POST' onsubmit="areCenterFieldsCorrect()">
                <div id="name-div" class="form-group">
                    <label for="name" data-translate="Nombre"></label>
                    <input type="text" class="form-control" id="name" name="name" data-translate="Introducir nombre"
                           value="<?php echo $this->center->getName() ?>" required maxlength="30" oninput="checkNameCenter(this)">
                </div>
