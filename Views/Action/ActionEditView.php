...
class ActionEditView {
    ...
    function render(){
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            ...
            <form  name = "EDIT" action='../Controllers/ActionController.php?action=edit' method='POST' onsubmit="return checkEditNameDescription()">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                           value="<?php echo $this->action->getName() ?>" required onblur="checkEmpty(this)">
                </div>
                <div class="form-group">
                    <label for="description" data-translate="Descripción"></label>
                    <input type="text" class="form-control" id="description" name="description"
                           value="<?php echo $this->action->getDescription() ?>" required onblur="checkEmpty(this)">
                </div>
