...
class BuildingEditView {
    ...
    function render(){
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            ...
            <form id="buildingForm" action='../Controllers/BuildingController.php?action=edit&id=<?php echo $this->building->getId() ?>'
                  method='POST' onsubmit="return areBuildingFieldsCorrect()">
                <div id="name-div" class="form-group">
                    <label for="name" data-translate="Nombre"></label>
                    <input type="text" class="form-control" id="name" name="name" data-translate="Introducir nombre"
                           value="<?php echo $this->building->getName() ?>" required
                           maxlength="30" oninput="checkNameBuilding(this)">
                </div>
                <div id="location-div" class="form-group">
                    ...
                    <input type="text" class="form-control" id="location" name="location" data-translate="Introducir localización"
                           value="<?php echo $this->building->getLocation() ?>" required
                           maxlength="30" oninput="checkLocationBuilding(this)">
                </div>
