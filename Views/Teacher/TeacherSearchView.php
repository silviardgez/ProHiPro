    ...
    function render()
    {
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mb-3 border-bottom">
                <h1 class="h2" data-translate="Búsqueda de profesores"></h1>
                <a class="btn btn-primary" role="button" href="../Controllers/TeacherController.php"><p
                        data-translate="Volver"></p></a>
            </div>
            <form id="teacherForm" action='../Controllers/TeacherController.php?action=search' method='POST'
                  onsubmit="areTeacherSearchFieldsCorrect()">
                <div class="form-group">
                    <label for="user_id" data-translate="Usuario"></label>
                    <select class="form-control" id="user_id" name="user_id" ?>
                        <option data-translate="Introducir usuario" value=""></option>
                        <?php foreach ($this->users as $user): ?>
                            <option value="<?php echo $user->getId() ?>">
                                <?php echo $user->getName()." ". $user->getSurname() ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div id="dedication-div" class="form-group">
                    ...
                    <input type="text" class="form-control" id="dedication" name="dedication"
                           data-translate="Introducir dedicación" maxlength="4"
                           oninput="checkDedicationEmptyTeacher(this)">
                </div>
                <div class="form-group">
