    ...
    function render()
    {
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mb-3 border-bottom">
                <h1 class="h2" data-translate="Insertar horario"></h1>
            ...
            <form id="teacherForm" action='../Controllers/ScheduleController.php?subject=<?php echo $this->subject ?>&action=add' method='POST'
                ...
                <div id="start-hour-div" class="form-group">
                    ...
                    <input type="time" class="form-control" id="start_hour" name="start_hour"
                           required oninput="checkStartHourTeacher(this)">
                </div>
                <div id="end-hour-div" class="form-group">
                    ...
                    <input type="time" class="form-control" id="end_hour" name="end_hour"
                           required oninput="checkEndHourTeacher(this)">
                </div>
