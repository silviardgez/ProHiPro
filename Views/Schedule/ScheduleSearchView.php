    ...
    function render()
    {
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mb-3 border-bottom">
                <h1 class="h2" data-translate="Búsqueda de horarios"></h1>
            ...
            <form id="teacherForm" action='../Controllers/ScheduleController.php?subject=<?php echo $this->subject ?>&action=search' method='POST'
                  onsubmit="areScheduleEmptyFieldsCorrect()">
                <div class="form-group">
                    ...
                    <select class="form-control" id="subject_group_id" name="subject_group_id">
                        <option data-translate="Introducir grupo" value=""></option>
                ...
                <div id="day-div" class="form-group">
                    <label for="day" data-translate="Día de inicio"></label>
                    <input type="date" class="form-control" id="day" name="day"
                           oninput="checkEmptyDayTeacher(this)">
                </div>
                <div id="start-hour-div" class="form-group">
                    ...
                    <input type="time" class="form-control" id="start_hour" name="start_hour"
                           oninput="checkEmptyStartHourTeacher(this)">
                </div>
                <div id="end-hour-div" class="form-group">
                    ...
                    <input type="time" class="form-control" id="end_hour" name="end_hour"
                           oninput="checkEmptyEndHourTeacher(this)">
                </div>
