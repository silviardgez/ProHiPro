    ...
    function render()
    {
        ...
        <main role="main" class="margin-main ml-sm-auto px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-2 mb-3">
                ...
                <!-- Search -->
                <form class="row" action='../Controllers/FuncActionController.php' method='POST'>
                ...
                <?php else:
                    if (HavePermission("FuncAction", "ADD")): ?>
                        <a class="btn btn-success" role="button"
                           href="../Controllers/FuncActionController.php?action=add">
                            <span data-feather="plus"></span>
                            <p data-translate="Añadir acción-funcionalidad"></p>
                        </a>
                    <?php endif; endif; ?>
            </div>
